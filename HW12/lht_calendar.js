...
{
    // monthName arrat contains the list of month names
...
function calWeekdayRow()
    ...
    function daysInMonth(calDate)
    {
        ...
        // extract the four digit year month calue 
        var thisYear = calDate.getFullYear();
        var thisMonth = calDate.getMonth();
    ...
    function calDays(calDate)
    {
        ...
        var day = new Date(calDate.getFullYear(), calDate.getMonth(), );
